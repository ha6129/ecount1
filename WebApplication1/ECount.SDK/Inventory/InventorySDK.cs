...
namespace ECountSDK
{
	public class InventorySDK : IInventorySDK
	{
		...
		public PurchaseSDK pursdk = new PurchaseSDK();
		public SaleSDK salsdk = new SaleSDK();
		public InventorySDK()
		{
		}	
		// 재고 현황의 정보를 최신화 한다
		...
		public List<Inventory> GetListStatus(DateTime datetime, bool includeZeroQuantity = false)
		{
			...
			{
				Console.WriteLine($"{item.Product.Code} {item.Quantity}");
			}
			return _inventory;
		}
